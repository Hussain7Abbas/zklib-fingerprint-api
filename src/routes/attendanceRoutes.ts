...
router.get('/summary', attendanceController.getAttendanceSummary.bind(attendanceController));

// DELETE /api/attendances/clear - Clear all attendance logs
router.delete('/clear', attendanceController.clearAttendanceLogs.bind(attendanceController));
